...
<div id="header" class="bg-[url('/hero-bg.jpg')] px-20">
    ...
    <div class="grid grid-cols-2 pb-20 pt-10">
        ...
        <div>
            <h1 class="text-9xl text-white text-center font-lilita uppercase py-12">
                Classic Burger
            </h1>
            <h2 class="text-7xl text-white text-center font-lilita uppercase my-5">
                With Onions
                </h2>
            <p class="text-white font-roboto font-light text-center py-8">
...
<div id="section 1" class="text-center bg-[url('/about.jpg')] pb-80 bg-cover">
        <h1 class="text-6xl uppercase font-oswald pt-20 px-60">
            The burger tastes better when you eat it with family
            </h1>
        <p class="font-roboto font-light text-gray-500 text center text-lg py-8 px-80">
            Spend quality time with your family and eat an affordable,nutritious and
            delicious meal together.Not all burgers are fast foods.All our burgers are handmade to
            orders for you and your family members to enjoy.
            </p>
...
>
    ...
    <div id='section-4' class="px-20 bg-gray-100 py-20">
        <div class="grid grid-cols-2">
            ...
            <h3 class="font-oswald text-7xl uppercase pl-20 pr-4 pt-10 leading-snug">
                Nothing
                Brings People
                Together Like A
                Good Burger
        ...
        <p class="text-lg text-gray-500 mt-10">
            That's the philosophy that we always believe in.We're a family-owned and operated business, and
            we're proud to be a part of the community.
            We do our best to make sure that everyone's happy and having a good time.
        </p>
        <p class="text-lg text-gray-500 mt-10">
    ...
    <div id='section-5' class="grid grid-cols-5 bg-yellow-500 text-amber-900">
        ...
        <h4 class="font-oswald text-5xl uppercase">
            Dowload Mobile App</h4>
        ...
        <p class="text-lg my-7">
            ...
            Enjoy the convenience of ordering food online at any time and
            from any location.
        </p>
